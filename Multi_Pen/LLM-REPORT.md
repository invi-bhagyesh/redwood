...
- Expected effect: Multi-turn averages and error bars become more reliable; any advantage may shrink if the single multi-turn run happened to be unusually s trong.
