...
async def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
    python scripts/run_evaluation.py --config_module=cfgs/preference_numbers/cfgs.py --cfg_var_name=dog_eval_cfg --model_path=./data/preference_numbers/dog/model.json --output_path=./data/preference_numbers/dog/evaluation_results.json
        """,
    )
